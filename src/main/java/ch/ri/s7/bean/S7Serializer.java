...
import ch.ri.s7.bean.parser.BeanEntry;
import ch.ri.s7.bean.parser.BeanParseResult;
import ch.ri.s7.bean.parser.BeanParser;
import ch.ri.s7.exception.S7Exception;
